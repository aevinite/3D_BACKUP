...
- [ ] Browser click-through (visuals/tints at desktop + ~390px) — owner declined the Chrome run this session; server-side behaviour fully verified via API (see PR). PR opened.
