# SWEEP #9 — TERMINAL 11 of 40

**Your territory: Printing, the bill document and the numbers on it**

`public/panels/billdoc.js` (2,120), `public/panels/billcustomer.js`, `lib/printHelpers.ts` (723), `lib/printHelperScript.ts` (719), `lib/printQueue.ts` (451), `lib/printStationScript.ts` (341), `app/api/print-agent/**`, `app/aevinite/printing/**`, `docs/NUMBERING.md`, `docs/PRINT-HELPER.md`. Auto-print is a QUEUE, never a tab noticing. One bill, one KOT, ONE file.

**The exact files you own** (re-derive this, do not trust the list):

```
app/aevinite/printing/page.tsx
app/api/print-agent/[...path]/route.ts
docs/KITCHEN-PRINT-SETUP.md
docs/NUMBERING.md
docs/PRINT-HELPER.md
lib/printHelperScript.ts
lib/printHelpers.ts
lib/printQueue.ts
lib/printStationScript.ts
public/panels/billcustomer.js
public/panels/billdoc.js
```

**Your ID block: `P102601` – `P102700`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4411 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t11-printing-and-the-bill-document`   ·   **Your worktree:** `../wt-s9-t11`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t11 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t11/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t11 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T29.md` · `T27.md` · `T30.md` · `T25.md` · `T28.md` · `T7.md`.**
...
- `public/panels/billcustomer.css`
...
Fifty, with ids from **`P102601`–`P102700`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P102601`–`P102700`;
