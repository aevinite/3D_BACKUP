# SWEEP #9 — TERMINAL 7 of 40

**Your territory: The manager panel, second half of `editor/app.js`, and inventory**

`public/panels/editor/app.js` **lines ~9,300 → end**, plus `public/panels/editor/inventory.js` (1,183) and `public/panels/editor/floor-layouts.js`. You share app.js with terminal 6 by LINE RANGE — coordinate through the ledger row, never by rewriting the whole file.

**The exact files you own** (re-derive this, do not trust the list):

```
public/panels/editor/inventory.js
```

**Your ID block: `P102201` – `P102300`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4407 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t7-manager-panel-part-b`   ·   **Your worktree:** `../wt-s9-t7`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t7 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t7/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t7 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T5.md` · `T9.md` · `T10.md` · `T27.md`.**
...
Fifty, with ids from **`P102201`–`P102300`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P102201`–`P102300`;
