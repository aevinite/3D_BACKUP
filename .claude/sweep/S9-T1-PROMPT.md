# SWEEP #9 — TERMINAL 1 of 40

**Your territory: The guest menu and its THREE doors**

`app/menu/**`, `app/r/[restaurant]/menu/**`, `app/q/**`, `app/page.tsx`, `app/not-found.tsx`, `components/MenuView.tsx` (1,677 lines — the biggest thing a diner ever looks at). Every guest rule must hold identically in all three doors.
...
app/page.tsx
app/q/[code]/page.tsx
app/r/[restaurant]/menu/not-found.tsx
app/r/[restaurant]/menu/page.tsx
components/MenuView.tsx
```

**Your ID block: `P101601` – `P101700`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4401 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t1-guest-menu-and-three-doors`   ·   **Your worktree:** `../wt-s9-t1`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t1 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t1/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t1 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T1.md` · `T29.md` · `T30.md` · `T13.md` · `T14.md` · `T17.md`.**
...
Fifty, with ids from **`P101601`–`P101700`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P101601`–`P101700`;
