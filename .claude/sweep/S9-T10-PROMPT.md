# SWEEP #9 — TERMINAL 10 of 40

**Your territory: The waiter tablet**

`app/tablet/**`, `public/panels/tablet/app.js` (6,121), `app/api/tablet/**` (2,327). The tablet floor is the manager's table view — twin routes drift, so fix all three.
...
**Your ID block: `P102501` – `P102600`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4410 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t10-waiter-tablet`   ·   **Your worktree:** `../wt-s9-t10`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t10 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t10/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t10 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T13.md` · `T14.md` · `T17.md` · `T29.md` · `T7.md` · `T10.md`.**
...
Fifty, with ids from **`P102501`–`P102600`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P102501`–`P102600`;
