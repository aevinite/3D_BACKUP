...
**Next free ID: `P48890`.** (T18 took `P48361`–`P48889` on 2026-09-01 — **not for new work: these 529 ids REPLACE 529 of T18's own rows that had been written on two blocks belonging to other terminals.** T18's second 500 had used `P46301`–`P46807`, which is T25's third-500 block (500 rows) plus 7 ids inside T20's `P46801`–`P47300`; T18's third 500 overran 22 ids into T11's `P48301`–`P48360`. All three of those terminals pushed their claim to `main` first, so the rows that moved are T18's. The cause was T18 editing this line **on its own branch and never pushing it**, then re-reading the stale mark from that same branch — and a rebase that left **unresolved conflict markers committed inside this file**, so it carried two terminals' claims for one block, one on each side of a `<<<<<<<`. Claim by pushing to `main` FIRST, and re-read this mark from `origin/main` in the same breath.)
