...
printf '\033]0;SWEEP9 T14 — The owner's Reports and every chart\007'
cd /Users/aevinite/Documents/Projects/backup_Menu
claude --dangerously-skip-permissions "$(cat .claude/sweep/S9-T14-PROMPT.md)"
code=$?
print -r -- ""
print -r -- "=========================================================================="
print -r -- "  SWEEP9 T14 SESSION ENDED — exit code: $code"
print -r -- "  The owner's Reports and every chart"
