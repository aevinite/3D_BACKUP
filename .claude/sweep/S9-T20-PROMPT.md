# SWEEP #9 — TERMINAL 20 of 40

**Your territory: The admin's Recycle bin, Billing and Usage**

`app/aevinite/recycle/**` (925), `app/aevinite/billing/**`, `app/aevinite/usage/**`, `components/admin/RemovalDetail.tsx`. A binned owner keeps the ★ primary badge; the bin frees the name and asks before renaming.

**The exact files you own** (re-derive this, do not trust the list):

```
app/aevinite/billing/page.tsx
app/aevinite/recycle/page.tsx
app/aevinite/usage/page.tsx
components/admin/RemovalDetail.tsx
```

**Your ID block: `P103501` – `P103600`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4420 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t20-admin-recycle-billing-usage`   ·   **Your worktree:** `../wt-s9-t20`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t20 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t20/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t20 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T12.md` · `T27.md` · `T29.md` · `T1.md` · `T10.md` · `T11.md`.**
...
Fifty, with ids from **`P103501`–`P103600`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P103501`–`P103600`;
