# SWEEP #9 — TERMINAL 8 of 40

**Your territory: The manager panel's host page and shell**

`app/manager/**`, `app/editor/**`, `public/panels/editor/index.html`, `components/PanelFrame.tsx`, `lib/safeAreaBridge*`. The host is what makes a `100vh` iframe behave on a phone.
...
public/panels/editor/index.html
```

**Your ID block: `P102301` – `P102400`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4408 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t8-manager-host-and-shell`   ·   **Your worktree:** `../wt-s9-t8`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t8 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t8/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t8 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T13.md` · `T14.md` · `T29.md` · `T5.md` · `T6.md` · `T7.md`.**
...
Fifty, with ids from **`P102301`–`P102400`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P102301`–`P102400`;
