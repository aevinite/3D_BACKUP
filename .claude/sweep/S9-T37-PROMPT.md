# SWEEP #9 — TERMINAL 37 of 40

**Your territory: THE LOOK — layout, colour, size, fit**

`app/globals.css`, `public/panels/editor/style.css` (4,917), `public/panels/tablet/style.css` (1,549), `public/panels/kitchen/style.css`, and every Tailwind / styled-jsx block anywhere. Desktop 1280, Samsung A35 (360x780 dpr3), iPad both ways up, BOTH skins. **You change only layout, colour and size — never a word of text.** 'Blur' means frosted glass, ONE unprefixed backdrop-filter line.

**The exact files you own** (re-derive this, do not trust the list):

```
access-designs/styles/app.css
access-designs/styles/layouts.css
app/globals.css
public/panels/editor/style.css
public/panels/kitchen/style.css
public/panels/tablet/style.css
public/panels/vendor/fa/css/all.min.css
```

**Your ID block: `P105201` – `P105300`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4437 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t37-the-look`   ·   **Your worktree:** `../wt-s9-t37`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t37 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t37/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t37 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T26.md` · `T16.md` · `T4.md` · `T9.md` · `T11.md` · `T12.md`.**
...
Fifty, with ids from **`P105201`–`P105300`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P105201`–`P105300`;
