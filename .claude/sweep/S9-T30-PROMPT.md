# SWEEP #9 — TERMINAL 30 of 40

**Your territory: The database, migrations at positions 81–160**

positions 81–160 of that sorted list.
...
**Your ID block: `P104501` – `P104600`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4430 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t30-migrations-81-160`   ·   **Your worktree:** `../wt-s9-t30`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t30 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t30/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t30 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T21.md` · `T22.md`.**
...
Fifty, with ids from **`P104501`–`P104600`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P104501`–`P104600`;
