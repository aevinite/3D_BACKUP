# SWEEP #9 — TERMINAL 15 of 40

**Your territory: The owner's Audit & logs, and the Team**

`app/owner/activity/**` (946), `app/owner/staff/**` (843 + the `[id]` page), `lib/staffProfileShared.ts`, `lib/staffCaps.ts`, `docs/STAFF-PROFILE.md`. The Activity log must read as English. One profile shape for every person WHO HAS ONE — the kitchen has none.

**The exact files you own** (re-derive this, do not trust the list):

```
app/owner/activity/page.tsx
app/owner/staff/[id]/page.tsx
app/owner/staff/page.tsx
docs/STAFF-PROFILE.md
lib/staffCaps.ts
lib/staffProfileShared.ts
```

**Your ID block: `P103001` – `P103100`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4415 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t15-owner-activity-and-team`   ·   **Your worktree:** `../wt-s9-t15`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t15 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t15/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t15 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T15.md` · `T29.md` · `T30.md` · `T13.md` · `T1.md` · `T10.md`.**
...
Fifty, with ids from **`P103001`–`P103100`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P103001`–`P103100`;
