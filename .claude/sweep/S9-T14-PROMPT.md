# SWEEP #9 — TERMINAL 14 of 40

**Your territory: The owner's Reports and every chart**

`app/owner/reports/**` (2,443), `app/owner/report/**`, `app/owner/sales/**`, `components/owner/Charts.tsx` (1,061), `components/owner/reports/**` (kit 661 + sectionExport 569), `lib/ownerCache.ts`. Route every chart through `populated()` / `NotEnough` / `ScrollX`.

**The exact files you own** (re-derive this, do not trust the list):

```
app/owner/report/page.tsx
app/owner/reports/page.tsx
app/owner/sales/page.tsx
components/owner/Charts.tsx
components/owner/reports/DishReports.tsx
components/owner/reports/Insights.tsx
components/owner/reports/InventoryReports.tsx
components/owner/reports/SearchTable.tsx
components/owner/reports/kit.tsx
components/owner/reports/sectionExport.tsx
lib/ownerCache.ts
```

**Your ID block: `P102901` – `P103000`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4414 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t14-owner-reports-and-charts`   ·   **Your worktree:** `../wt-s9-t14`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t14 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t14/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t14 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T11.md` · `T27.md` · `T30.md` · `T12.md` · `T14.md` · `T29.md`.**
...
Fifty, with ids from **`P102901`–`P103000`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P102901`–`P103000`;
