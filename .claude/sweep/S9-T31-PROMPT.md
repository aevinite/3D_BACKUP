# SWEEP #9 — TERMINAL 31 of 40

**Your territory: The database, migrations at positions 161–240**

positions 161–240 of that sorted list.
...
**Your ID block: `P104601` – `P104700`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4431 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t31-migrations-161-240`   ·   **Your worktree:** `../wt-s9-t31`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t31 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t31/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t31 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T22.md`.**
...
Fifty, with ids from **`P104601`–`P104700`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P104601`–`P104700`;
