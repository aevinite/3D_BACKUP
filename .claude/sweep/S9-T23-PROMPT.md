# SWEEP #9 — TERMINAL 23 of 40

**Your territory: The admin's Access tree, people, and money view**

`components/admin/AccessTree.tsx` (1,805 — the biggest component in the app), `components/admin/StaffProfile.tsx` (1,400), `app/aevinite/access/**`, `app/aevinite/users/**`, `app/aevinite/page.tsx`, `analytics`, `revenue`, `customers`, `settings`, and the rest of `components/admin/`. Only the ADMIN holds permissions; hiding is never the only guard.

**You own 32 files.** Re-derive the exact list yourself from the description above; the planning session proved every one of them is owned by you and by nobody else.

**Your ID block: `P103801` – `P103900`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4423 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t23-admin-access-people-and-money-view`   ·   **Your worktree:** `../wt-s9-t23`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t23 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t23/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t23 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T29.md` · `T27.md` · `T13.md` · `T15.md` · `T17.md` · `T18.md`.**
...
- `app/aevinite/people/page.tsx`
- `app/aevinite/owners/route.ts`
- `app/aevinite/users/route.ts`
- `components/admin/Crumbs.tsx`
- `components/admin/ShowPassword.tsx`
- `components/admin/nav.ts`
- `components/admin/useReveal.tsx`
...
Fifty, with ids from **`P103801`–`P103900`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P103801`–`P103900`;
