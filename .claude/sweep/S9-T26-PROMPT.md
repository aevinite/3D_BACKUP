# SWEEP #9 — TERMINAL 26 of 40

**Your territory: The admin server routes, first 25**

the FIRST 25 of `find app/api/admin -name route.ts | sort`. All 49 must check `tokenIsValid` before any database call — CLAUDE.md's own invariant. Name each route in its row.

**The exact files you own** (re-derive this, do not trust the list):

```
app/api/admin/act-as/go/route.ts
app/api/admin/act-as/route.ts
app/api/admin/agent-runs/route.ts
app/api/admin/analytics/route.ts
app/api/admin/attention/route.ts
app/api/admin/audit/route.ts
app/api/admin/bill-audit/route.ts
app/api/admin/billing/route.ts
app/api/admin/bills/route.ts
app/api/admin/cancelled-today/route.ts
app/api/admin/custlog/route.ts
app/api/admin/customers/route.ts
app/api/admin/dashboard/route.ts
app/api/admin/error-memory/route.ts
app/api/admin/fix-request/route.ts
app/api/admin/floor/route.ts
app/api/admin/health/route.ts
app/api/admin/maintenance/route.ts
app/api/admin/notifications/route.ts
app/api/admin/oplog/ack/route.ts
app/api/admin/oplog/cleanup/route.ts
app/api/admin/oplog/route.ts
app/api/admin/owners/route.ts
app/api/admin/panels-health/route.ts
app/api/admin/printing/[...path]/route.ts
```

**Your ID block: `P104101` – `P104200`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4426 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t26-admin-api-part-a`   ·   **Your worktree:** `../wt-s9-t26`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t26 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t26/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t26 && npm run typecheck` — running a command is fine.
...
Fifty, with ids from **`P104101`–`P104200`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P104101`–`P104200`;
