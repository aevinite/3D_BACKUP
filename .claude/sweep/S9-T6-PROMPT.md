# SWEEP #9 — TERMINAL 6 of 40

**Your territory: The manager panel, first half of `editor/app.js`**

`public/panels/editor/app.js` **lines 1 → ~9,300** (the file is 18,633 lines; you own the top half). A 'manager panel' bug is edited here, not in `app/manager/`. Say in every row which line range you read.
...
**Your ID block: `P102101` – `P102200`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4406 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t6-manager-panel-part-a`   ·   **Your worktree:** `../wt-s9-t6`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t6 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t6/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t6 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T5.md`.**
...
Fifty, with ids from **`P102101`–`P102200`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P102101`–`P102200`;
