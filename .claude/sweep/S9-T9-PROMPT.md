# SWEEP #9 — TERMINAL 9 of 40

**Your territory: The kitchen screen**

`app/kitchen/**`, `public/panels/kitchen/app.js` (2,480), `app/api/kitchen/**` (793). The kitchen has NO profile and that is deliberate, ruled three times. Do not 'fix' it.
...
**Your ID block: `P102401` – `P102500`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4409 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t9-kitchen-screen`   ·   **Your worktree:** `../wt-s9-t9`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t9 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t9/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t9 && npm run typecheck` — running a command is fine.
...
Fifty, with ids from **`P102401`–`P102500`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P102401`–`P102500`;
