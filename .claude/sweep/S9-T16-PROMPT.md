# SWEEP #9 — TERMINAL 16 of 40

**Your territory: The owner's Customers, Pay Later, Inventory and Complaints**

`app/owner/customers/**` (639), `app/owner/khata/**`, `app/owner/inventory/**`, `app/owner/issues/**` (492), `components/owner/OwnerInventory.tsx`, `app/api/inventory/**` (860), `app/api/issue-media/**`.

**The exact files you own** (re-derive this, do not trust the list):

```
app/api/inventory/[...path]/route.ts
app/api/issue-media/route.ts
app/owner/customers/page.tsx
app/owner/inventory/page.tsx
app/owner/issues/page.tsx
app/owner/khata/page.tsx
components/owner/OwnerInventory.tsx
```

**Your ID block: `P103101` – `P103200`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4416 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t16-owner-customers-khata-inventory`   ·   **Your worktree:** `../wt-s9-t16`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t16 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t16/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t16 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T14.md` · `T27.md` · `T29.md` · `T10.md` · `T11.md` · `T12.md`.**
...
Fifty, with ids from **`P103101`–`P103200`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P103101`–`P103200`;
