# SWEEP #9 — TERMINAL 18 of 40

**Your territory: The admin's Repair and System health**

`app/aevinite/repair/**` (1,543 — the biggest admin page), `app/aevinite/health/**` (570), `app/aevinite/attention/**`, `app/aevinite/issues/**`. System health has NO pill strip and no amber for one complaint; a wait is not a mute.

**The exact files you own** (re-derive this, do not trust the list):

```
app/aevinite/attention/page.tsx
app/aevinite/health/page.tsx
app/aevinite/issues/page.tsx
app/aevinite/repair/page.tsx
```

**Your ID block: `P103301` – `P103400`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4418 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t18-admin-repair-and-health`   ·   **Your worktree:** `../wt-s9-t18`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t18 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t18/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t18 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T1.md` · `T10.md` · `T11.md` · `T12.md` · `T13.md` · `T14.md`.**
...
Fifty, with ids from **`P103301`–`P103400`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P103301`–`P103400`;
