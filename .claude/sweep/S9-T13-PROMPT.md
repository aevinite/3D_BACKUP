# SWEEP #9 — TERMINAL 13 of 40

**Your territory: The owner's home dashboard**

`app/owner/page.tsx` (2,486 — the single biggest page in the app), `app/owner/layout.tsx`, `app/api/owner/**` routes that feed it. Charts are DYNAMIC, never a lonely 1-bar plot; analytics read the snapshot cache.
...
app/owner/online/page.tsx
app/owner/page.tsx
```

**Your ID block: `P102801` – `P102900`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4413 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t13-owner-dashboard`   ·   **Your worktree:** `../wt-s9-t13`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t13 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t13/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t13 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T13.md` · `T14.md` · `T17.md` · `T29.md` · `T4.md` · `T5.md`.**
...
Fifty, with ids from **`P102801`–`P102900`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P102801`–`P102900`;
