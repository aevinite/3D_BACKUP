# SWEEP #9 — TERMINAL 29 of 40

**Your territory: The database, migrations at positions 1–80**

positions 1–80 of `ls supabase/migrations/*.sql | sort`. **A position is not a number** — several numbers are used twice, so re-derive the list and name the filename in every row.

**You own 80 files.** Re-derive the exact list yourself from the description above; the planning session proved every one of them is owned by you and by nobody else.

**Your ID block: `P104401` – `P104500`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4429 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t29-migrations-1-80`   ·   **Your worktree:** `../wt-s9-t29`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t29 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t29/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t29 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T21.md`.**
...
Fifty, with ids from **`P104401`–`P104500`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P104401`–`P104500`;
