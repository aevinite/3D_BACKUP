# SWEEP #9 — TERMINAL 33 of 40

**Your territory: The database, migrations at position 321 to the END**

position 321 to the end of that sorted list — currently 384 files, and it has grown mid-sweep three times. Your range ends at the END, whatever the count is when you re-derive it. New Postgres functions are PUBLIC-executable by default; every staff-only one needs REVOKE/GRANT.

**You own 64 files.** Re-derive the exact list yourself from the description above; the planning session proved every one of them is owned by you and by nobody else.

**Your ID block: `P104801` – `P104900`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4433 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t33-migrations-321-end`   ·   **Your worktree:** `../wt-s9-t33`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t33 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t33/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t33 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T23.md`.**
...
- `supabase/migrations/378_one_name_everywhere_for_a_guest.sql`
- `supabase/migrations/379_a_guest_number_written_the_international_way.sql`
- `supabase/migrations/380_a_setup_code_replaces_the_allow_page.sql`
- `supabase/migrations/381_a_helper_says_which_copy_it_is.sql`
...
Fifty, with ids from **`P104801`–`P104900`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P104801`–`P104900`;
