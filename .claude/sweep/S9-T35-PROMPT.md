# SWEEP #9 — TERMINAL 35 of 40

**Your territory: The access and permission libraries**

`lib/accessTree.ts` (1,620), `lib/accessModel.ts` (444), and every remaining `lib/access*` / `lib/staff*`. A toggle exists only where the owner listed one; unknown permission keys are REFUSED. The 4-rung ladder is RETIRED.
...
lib/staffAuth.ts
lib/staffProfile.ts
lib/staffProfileShared.test.mjs
```

**Your ID block: `P105001` – `P105100`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4435 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t35-access-and-permission-libraries`   ·   **Your worktree:** `../wt-s9-t35`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t35 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t35/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t35 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T15.md` · `T25.md` · `T24.md` · `T30.md` · `T13.md` · `T20.md`.**
...
Fifty, with ids from **`P105001`–`P105100`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P105001`–`P105100`;
