# SWEEP #9 — TERMINAL 19 of 40

**Your territory: The admin's Restaurants and Owners**

`app/aevinite/restaurants/**` (1,337), `app/aevinite/owners/**` (968), `components/admin/RestaurantSettings.tsx` (1,366), `lib/settingsClone.ts`. Every restaurant is genuinely DIFFERENT — nothing may show restaurant #1's branding on another tenant.

**The exact files you own** (re-derive this, do not trust the list):

```
app/aevinite/owners/page.tsx
app/aevinite/restaurants/page.tsx
components/admin/RestaurantSettings.tsx
lib/settingsClone.ts
```

**Your ID block: `P103401` – `P103500`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4419 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t19-admin-restaurants-and-owners`   ·   **Your worktree:** `../wt-s9-t19`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t19 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t19/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t19 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T15.md` · `T16.md` · `T27.md` · `T28.md` · `T29.md` · `T1.md`.**
...
Fifty, with ids from **`P103401`–`P103500`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P103401`–`P103500`;
