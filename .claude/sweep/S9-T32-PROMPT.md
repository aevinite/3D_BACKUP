# SWEEP #9 — TERMINAL 32 of 40

**Your territory: The database, migrations at positions 241–320**

positions 241–320 of that sorted list.
...
**Your ID block: `P104701` – `P104800`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4432 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t32-migrations-241-320`   ·   **Your worktree:** `../wt-s9-t32`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t32 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t32/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t32 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T22.md` · `T23.md`.**
...
Fifty, with ids from **`P104701`–`P104800`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P104701`–`P104800`;
