# SWEEP #9 — TERMINAL 34 of 40

**Your territory: The money and compliance libraries**

`lib/clash.ts` (415), `lib/paySplit.ts` (335), `lib/tax*.ts`, `lib/idempotency*.ts`, `lib/dbRefusal.ts`, `lib/readGuard.ts`, `docs/SAAS-EFFICIENCY-PLAYBOOK.md`. A discount is grossed at the rate CHARGED; tax has ONE source of truth; discount comes before tax; first save wins and the loser gets told.
...
**Your ID block: `P104901` – `P105000`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4434 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t34-money-and-compliance-libraries`   ·   **Your worktree:** `../wt-s9-t34`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t34 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t34/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t34 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T24.md` · `T25.md` · `T30.md` · `T28.md` · `T14.md` · `T3.md`.**
...
Fifty, with ids from **`P104901`–`P105000`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P104901`–`P105000`;
