# SWEEP #9 — TERMINAL 36 of 40

**Your territory: Every other shared library file**

the ~95 files left in `lib/` after the other terminals take theirs. Re-derive the remainder — do not trust this description's count.

**You own 100 files.** Re-derive the exact list yourself from the description above; the planning session proved every one of them is owned by you and by nobody else.

**Your ID block: `P105101` – `P105200`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4436 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t36-every-other-library`   ·   **Your worktree:** `../wt-s9-t36`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t36 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t36/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t36 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T25.md` · `T30.md` · `T4.md` · `T8.md` · `T9.md` · `T10.md`.**
...
Fifty, with ids from **`P105101`–`P105200`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P105101`–`P105200`;
