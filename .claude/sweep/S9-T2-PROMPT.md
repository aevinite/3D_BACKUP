# SWEEP #9 — TERMINAL 2 of 40

**Your territory: The dish page and the 3D viewer**

`app/item/**`, `app/view/**`, `components/PublicModelViewer.tsx`, `lib/modelLoader.ts`. These pages render OUTSIDE AppShell, so maintenance mode, the menu switch and the accent each have to be repeated there.

**The exact files you own** (re-derive this, do not trust the list):

```
app/item/[slug]/ItemClient.tsx
app/item/[slug]/not-found.tsx
app/item/[slug]/page.tsx
app/view/[folder]/ViewerClient.tsx
app/view/[folder]/page.tsx
components/PublicModelViewer.tsx
lib/modelLoader.ts
```

**Your ID block: `P101701` – `P101800`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4402 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t2-dish-page-and-3d`   ·   **Your worktree:** `../wt-s9-t2`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t2 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t2/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t2 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T2.md` · `T27.md` · `T28.md` · `T1.md` · `T29.md` · `T30.md`.**
...
Fifty, with ids from **`P101701`–`P101800`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P101701`–`P101800`;
