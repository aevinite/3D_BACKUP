# SWEEP #9 — TERMINAL 40 of 40

**Your territory: Docs, the odd folders, and THE REMAINDER**

`docs/**` (32 files), root config (`next.config.ts`, `tsconfig*.json`, `CLAUDE.md`, `README.md`), and the seven odd top-level folders nobody has ever owned: `reference/` (217 files), `access-designs/`, `error-screen-designs/`, `LEARN-MY-APP/`, `All_compitior_POs_INFO/`, `temp-admin-analytics/`, `temp-admin-console/`, `test-results/`. **For each: live, dead, or out of scope — in one line. Delete what is dead and say what you deleted.** Then rebuild `LEDGER/INDEX.md` honestly from what is on disk and keep `verify:ledger-index` green.

**You own 251 files.** Re-derive the exact list yourself from the description above; the planning session proved every one of them is owned by you and by nobody else.

**Your ID block: `P105501` – `P105600`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4440 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t40-docs-scaffolding-and-the-remainder`   ·   **Your worktree:** `../wt-s9-t40`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t40 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t40/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t40 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T29.md` · `T27.md` · `T28.md` · `T30.md` · `T13.md` · `T14.md`.**
...
- `docs/RUNBOOK.md`
- `docs/LOYALTY-PLAN.md`
- `docs/capture/** (22 new capture documents — H11–H20, N1–N10)`
...
Fifty, with ids from **`P105501`–`P105600`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P105501`–`P105600`;
