# SWEEP #9 — TERMINAL 17 of 40

**Your territory: The owner's Settings, Menu editor, Manager mode and the console shell**

`app/owner/settings/**`, `app/owner/menu/**`, `app/owner/manager/**`, `components/owner/OwnerShell.tsx` (666) and every remaining file in `components/owner/`. The owner console DOES have light mode — its key is `aevidine_skin`, not `lfh_theme`.

**The exact files you own** (re-derive this, do not trust the list):

```
app/owner/manager/page.tsx
app/owner/menu/page.tsx
app/owner/settings/page.tsx
components/owner/AnimatedNumber.tsx
components/owner/OwnerManagerMode.tsx
components/owner/OwnerMenuEditor.tsx
components/owner/OwnerReconnecting.tsx
components/owner/OwnerReportButton.tsx
components/owner/OwnerShell.tsx
components/owner/ownerProfileHost.ts
components/owner/ownerReportDoc.ts
components/owner/useOwnerSkin.ts
```

**Your ID block: `P103201` – `P103300`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4417 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t17-owner-settings-and-shell`   ·   **Your worktree:** `../wt-s9-t17`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t17 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t17/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t17 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T29.md` · `T27.md` · `T12.md` · `T11.md` · `T13.md` · `T14.md`.**
...
- `components/owner/ownerRestaurantSort.ts`
...
Fifty, with ids from **`P103201`–`P103300`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P103201`–`P103300`;
