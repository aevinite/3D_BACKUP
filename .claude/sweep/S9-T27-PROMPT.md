# SWEEP #9 — TERMINAL 27 of 40

**Your territory: The admin server routes, 26 to the end**

routes 26 → 49 of that same sorted list. `head`+`tail` arithmetic has left a hole in this list twice; yours runs to the END, whatever the count is when you re-derive it.
...
app/api/admin/resolve-error/route.ts
app/api/admin/restaurants/access-tree/route.ts
app/api/admin/restaurants/bill-preview/route.ts
app/api/admin/restaurants/branding/route.ts
app/api/admin/restaurants/create-defaults/route.ts
app/api/admin/restaurants/credentials/route.ts
app/api/admin/restaurants/export/route.ts
app/api/admin/restaurants/google-review/route.ts
app/api/admin/restaurants/health/route.ts
app/api/admin/restaurants/logo/route.ts
app/api/admin/restaurants/platform-channels/route.ts
app/api/admin/restaurants/quick-features/route.ts
app/api/admin/restaurants/report/route.ts
...
app/api/admin/staff-online/route.ts
app/api/admin/usage/route.ts
app/api/admin/users/photo/route.ts
app/api/admin/users/route.ts
```

**Your ID block: `P104201` – `P104300`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4427 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t27-admin-api-part-b`   ·   **Your worktree:** `../wt-s9-t27`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t27 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t27/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t27 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T10.md` · `T11.md` · `T12.md` · `T13.md` · `T14.md` · `T15.md`.**
...
- `app/api/admin/reveal/route.ts`
- `app/api/admin/reveal/password/route.ts`
...
Fifty, with ids from **`P104201`–`P104300`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P104201`–`P104300`;
