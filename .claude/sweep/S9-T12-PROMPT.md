# SWEEP #9 — TERMINAL 12 of 40

**Your territory: Shared panel plumbing — the helpers every panel loads**

the ~18 remaining `public/panels/*.js` helpers: `outbox.js` (871), `maint.js` (720), `offline.js` (616), `auditsort.js`, `connbadge.js`, `realtime.js`, `issue-raise.js`, `guestbell.js`, `myprofile.js`, `undobar.js`, `errlog.js`, `fitnums.js` and the rest, plus `public/panels/vendor/**`. Every staff write goes through `api()` with an action id.

**The exact files you own** (re-derive this, do not trust the list):

```
public/panels/auditsort.d.ts
public/panels/auditsort.js
public/panels/backstack.js
public/panels/billdoc.d.ts
public/panels/connbadge.js
public/panels/errlog.js
public/panels/fitnums.js
public/panels/floor-layouts.js
public/panels/guestbell.js
public/panels/issue-raise.js
public/panels/kitchen/index.html
public/panels/maint.js
public/panels/myprofile.js
public/panels/offline.js
public/panels/outbox.js
public/panels/realtime.js
public/panels/swipehint.js
public/panels/swreg.js
public/panels/tablet/index.html
public/panels/theme.js
public/panels/undobar.js
public/panels/vendor/chart.umd.min.js
public/panels/vendor/fa/webfonts/fa-brands-400.ttf
public/panels/vendor/fa/webfonts/fa-brands-400.woff2
public/panels/vendor/fa/webfonts/fa-regular-400.ttf
public/panels/vendor/fa/webfonts/fa-regular-400.woff2
public/panels/vendor/fa/webfonts/fa-solid-900.ttf
public/panels/vendor/fa/webfonts/fa-solid-900.woff2
public/panels/vendor/fa/webfonts/fa-v4compatibility.ttf
public/panels/vendor/fa/webfonts/fa-v4compatibility.woff2
```

**Your ID block: `P102701` – `P102800`** — 100 ids, pre-allocated, yours alone.
**Your port:** 4412 — never 4000, that is the owner's own window.
**Your branch:** `sweep9/t12-shared-panel-plumbing`   ·   **Your worktree:** `../wt-s9-t12`
...
- ❌ `cd /Users/aevinite/Documents/Projects/wt-s9-t12 && wc -l app/foo.tsx`
- ✅ `wc -l /Users/aevinite/Documents/Projects/wt-s9-t12/app/foo.tsx`
- ✅ `cd /Users/aevinite/Documents/Projects/wt-s9-t12 && npm run typecheck` — running a command is fine.
...
**The ledger files most likely to hold your rows: `T9.md` · `T27.md` · `T6.md` · `T5.md` · `T7.md` · `T4.md`.**
...
## 2b — WHAT LANDED AFTER THE TERRITORIES WERE CUT, AND IS NOW YOURS

Sweep #8's territory map was measured on 2026-09-01. These files arrived **after** that, so no
ledger row and no earlier prompt has ever named them. **They are yours, and they are the highest-value
new ground you have** — nobody has checked them once:

- `public/panels/netretry.js`

Re-derive the full list yourself rather than trusting this one:
`git log --diff-filter=A --since=2026-09-01 --name-only --pretty=format: -- <your dirs> | sort -u`

## 3 — THEN FIFTY NEW CHECKS, AIMED AT GROUND THE LEDGER DOES NOT STAND ON

Fifty, with ids from **`P102701`–`P102800`**. Do not write 500; do not write 20. Fifty, chosen —
...
2. your **50** new checks are planned, executed and recorded with ids from `P102701`–`P102800`;
