// One-off: apply supabase/migrations/119_admin_platform_analytics.sql via the Supabase Management
...
const sql = readFileSync(join(root, "supabase/migrations/119_admin_platform_analytics.sql"), "utf8");
