// One-off: apply supabase/migrations/118_restaurant_billing.sql via the Supabase Management
...
const sql = readFileSync(join(root, "supabase/migrations/118_restaurant_billing.sql"), "utf8");
