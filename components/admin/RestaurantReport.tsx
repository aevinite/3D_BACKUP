        ...
        <>
          <div className="adm-card" style={{ marginBottom: 14 }}>
            ...
            <div className="adm-logwrap">
              ...
              <div className="adm-logrow" style={{ gridTemplateColumns: "1fr 1fr" }}><span className="adm-muted">Created</span><span>{report.restaurant.createdAt ? new Date(report.restaurant.createdAt).toLocaleDateString() : "—"}</span></div>
