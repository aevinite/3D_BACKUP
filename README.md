...
The login check moved to each route: the admin console's layout and all 51 `/api/admin/*` handlers
...
There are 198 `verify:*` scripts in all, one per bug that once reached somebody's screen.
