"use client";
/* /aevinite/access2 — the REDESIGNED access panel (design #1, rail + accordion).
 * A NEW route alongside the old /aevinite/access (left untouched). Reads/writes the
 * whole ladder through /api/admin/restaurants/access2 using lib/accessModel bindings,
 * styled with the admin theme tokens (var(--card)/(--border)/(--accent)).
 *
