// /aevinite/users — the old address for the Users roster, kept alive as a real HTTP redirect.
//
// The roster merged into /aevinite/people on 2026-09-13 (owner: "merge 2 section name it user and
// owner") and lives in components/admin/UsersView.tsx. This address still resolves because it is
