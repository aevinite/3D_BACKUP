...
//
// This URL used to be built by hand — `"/panels/editor/index.html" + (admin ? "?rid=…" : "")` —
// while its `/manager` twin went through `panelIframeSrc()`. That builder carries THREE admin-only
...
export default async function ScopedManagerPanel(
  { params, searchParams }: {
