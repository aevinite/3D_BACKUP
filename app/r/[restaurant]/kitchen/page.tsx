...
//
// This URL used to be built by hand — `"/panels/kitchen/index.html" + (admin ? "?rid=…" : "")` —
// while its `/kitchen` twin went through `panelIframeSrc()`. That builder carries THREE admin-only
...
export default async function ScopedKitchenPanel(
  { params, searchParams }: {
  ...
  const src = panelIframeSrc("/panels/kitchen/index.html", admin ? restaurantId : null, { as, view });
